    ...
    <div class="card shadow p-4">
        ...
        <form action="{{ route('add_book') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title" class="form-control" placeholder="Enter Your Name" value="{{ old('title') }}">
                @if($errors->has('title'))
            ...
            <div class="mb-3">
                ...
                <input type="text" name="author" id="author" class="form-control" placeholder="Enter Author" value="{{ old('author') }}">
