...
<div class="container mt-4">
    ...
    <form action="{{route('add_book')}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="" class="form-control" placeholder="Enter Your Name" aria-describedby="helpId" value="{{old('title')}}">
            @if($errors->has('title'))
        ...
        <div class="mb-3">
            ...
            <input type="text" name="price" id="" class="form-control" placeholder="Enter stock" aria-describedby="helpId" value="{{old('price')}}">
            @if($errors->has('price'))
